...
\draft{Add some words here to link from previous chapter once that is written.}
...
\caption[Encoding the sample genealogy]{Illustration of how the sample genealogy is encoded. For clarity the genealogy of the whole population is shown, but  \subref{fig:encoding_a} Relationships induced by resampling in a sample of $n=6$ particles over four iterations. \subref{fig:encoding_b} The genealogy of these six particles, labelled with the value of the genealogical process $G_t$ at each time.}
