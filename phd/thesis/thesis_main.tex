...
%%% BIBLIOGRAPHY
\usepackage[citestyle=authoryear, sorting=nyt, backend=biber]{biblatex} %%% use \cite, \textcite and \parencite commands in text
...
\newmdtheoremenv[backgroundcolor=gray!20, linewidth=0pt]{corollary}{Corollary}[chapter]
\newmdtheoremenv[backgroundcolor=gray!20, linewidth=0pt]{prop}{Proposition}[chapter]
\newmdtheoremenv[backgroundcolor=gray!20, linewidth=0pt]{lemma}{Lemma}[chapter]
\theoremstyle{definition}
\newmdtheoremenv[backgroundcolor=gray!20, linewidth=0pt]{defn}{Definition}[chapter]
...
\vspace{1.5cm}
January 2021 %%% update submission date (month year)
\end{large}
\end{titlepage}
...
\chapter[Abstract]{} %%% remove the "Abstract" title once done
...
\chapter[List of Acronyms]{List of Acronyms}
