...
Taking the supremum and maximum then indicates whether there is a jump within any of the intervals of the given partition; this can only be equal to zero if all of the jumps occur exactly at the times $T_0, \dots, T_k$. 
...
Following \textcite{mohle1999}, we now construct the two-dimensional \seb{conditionally on $\mathcal{F}$ ?} Markov process $(Z_t, S_t)_{t \in \mathbb{N}_0}$ with transition probabilities
\begin{equation}
