...
\end{prop}
We now require bounds on $q_t$, somewhat stronger than those in \eqref{eq:gq_bounds_mn} as the bounds are now uniform in $x^\prime$.
\seb{Are we sure they need to be uniform in $x^\prime$?}
