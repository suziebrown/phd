...
\item The above results hold even if the resampling scheme to use at each iteration is chosen on-the-fly --- notably including adaptive resampling, parallel resampling, adaptive pruning/enrichment --- but you can imagine some other eccentric mixes of resampling schemes!
\end{itemize}
