...
\item [smoothing] $p(x_{0:t}\mid y_{0:t})$: inferring the sequence of states up to now $x_{0:t}$ from the observations up to now $y_{0:t}$
...
By construction, the full smoothing distribution is precisely
\begin{align*}
\mathbb{Q}_t (dx_{0:t})
