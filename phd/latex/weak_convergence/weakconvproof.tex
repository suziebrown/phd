...
\end{align} 
We will see that \eqref{eq:53} will contribute $e^{-\alpha_n t}$ to the limit in Lemma \ref{thm:induction_LB}, while the other terms in \eqref{eq:51} will not contribute to the limit.
