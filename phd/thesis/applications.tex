...
Suppose that\seb{for each $t$? --- actually, isn't is sufficient that these bounds exist for infinitely many $t$?} there exists a constant $\varepsilon \in (0,1]$ and a probability density $h$ such that
\begin{equation*}
