...
\geq \frac{3\delta^\prime \varepsilon^{2N} }{4}
\end{equation*}
using \eqref{eq:strat_pbounds} and %the lower bounds in 
Table~\ref{tab:strat_probs} ($p_0$, U.B.).
Similarly, if $\delta^\prime \in [1,2)$ then by Table~\ref{tab:strat_probs} ($p_{-1}$, U.B.),
%\begin{equation*}
%1 - p_{-1}^{(i^\star)}
...
\Prob[ c_N(t) > 2/N^2 \mid \mathcal{H}_t ]
\geq \min_{\delta^\prime \geq \delta} 
        \left\{ \frac{3\delta^\prime \varepsilon^{2N} }{4}\I{\delta^\prime \in [0,1)}
        + \frac{3 \varepsilon^{2N} }{4}\I{\delta^\prime \in [1,2)}
        + I{\delta^\prime \geq 2} \right\}
...
\begin{equation*}
1- p_1^{(j^\star)}
\geq \left( 1- \frac{1+ (1-\delta^\prime)}{2} \right) \varepsilon^{2N}
= \frac{ \delta^\prime \varepsilon^{2N} }{2} ,
\end{equation*}
...
\Prob[ c_N(t) > 2/N^2 \mid \mathcal{H}_t ]
\geq \min_{\delta^\prime \geq \delta} 
        \left\{ \frac{ \delta^\prime \varepsilon^{2N} }{2} 
        \I{\delta^\prime \neq 0} \right\}
= \frac{ \delta \varepsilon^{2N} }{2} .
\end{equation*}
