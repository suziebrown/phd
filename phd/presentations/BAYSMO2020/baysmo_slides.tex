...
\begin{frame}{Kingman's $n$-coalescent} %%% Add the wiki picture of KC on this slide
\begin{itemize}
\pause
...
\begin{frame}{Resampling} %%% combine with previous slide somehow
...
\begin{frame}{Stochastic roundings} %%% combine this onto previous slide?
\begin{itemize}
\item $X_i = N\wt{i}$
\item $\vt{i} = Y_i$
