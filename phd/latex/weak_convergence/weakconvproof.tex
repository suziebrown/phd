...
\prod_{j=1}^l \{ c_N(s_j) - B_n^\prime D_N(s_j) \}
\end{align}
Starting with the first line on the RHS:
\begin{align}
1 + &\sum_{l=1}^{\tau_N(t)}
\{ -\alpha_n (1+O(N^{-1})) \}^l 
\sum_{\substack{s_1<\dots<s_l \\ =1  }}^{\tau_N(t)}
...
\left( \prod_{i=1}^I c_N(s_i) \right) \left( \prod_{j=I+1}^l D_N(s_j) \right) 
\right\} \notag\\
&\leq 1 +  \sum_{l=1}^{\tau_N(t)} \frac{1}{l!} \{ \alpha_n (1+O(N^{-1})) \}^l 
\sum_{\substack{s_1 \neq\dots\neq s_l \\ =1  }}^{\tau_N(t)} \prod_{i=1}^l c_N(s_i) \notag\\
&\qquad+  \sum_{l=1}^{\tau_N(t)} \frac{1}{l!} \{ \alpha_n (1+O(N^{-1})) \}^l 
\sum_{\substack{s_1 \neq\dots\neq s_l \\ =1  }}^{\tau_N(t)}
\sum_{\substack{I=0\\\text{even} }}^l
\binom{l}{I} (B_n^\prime)^{l-I} 
\left( \prod_{i=1}^I c_N(s_i) \right) \left( \prod_{j=I+1}^l D_N(s_j) \right) \notag\\
...
\binom{l}{I} (B_n^\prime)^{l-I} 
\left( \prod_{i=1}^I c_N(s_i) \right) \left( \prod_{j=I+1}^l D_N(s_j) \right) \notag\\
&\leq \sum_{l=0}^{\tau_N(t)} \frac{1}{l!} \{ - \alpha_n (1+O(N^{-1})) \}^l 
\{ t + c_N(\tau_N(t)) \}^l \notag\\
&\qquad+ \sum_{l=1}^{\tau_N(t)} \frac{1}{l!} \{ \alpha_n (1+O(N^{-1})) \}^l 
...
\sum_{l=1}^{\tau_N(t)} \frac{1}{l!} \{ \alpha_n (1+O(N^{-1})) \}^l 
...
Now the second line:
\begin{align}
- \sum_{l=1}^{\tau_N(t)} &\{ -\alpha_n (1+O(N^{-1})) \}^l 
\sum_{\substack{s_1<\dots<s_l \\ \in \{r_1,\dots,r_k\} }}
\prod_{j=1}^l \{ c_N(s_j) - B_n^\prime D_N(s_j) \} \notag\\
&= - \sum_{l=1}^{k} \frac{1}{l!} \{ \alpha_n (1+O(N^{-1})) \}^l 
...
&\leq \sum_{l=0}^{\tau_N(t)} \frac{1}{l!} \{ - \alpha_n (1+O(N^{-1})) \}^l t^l
+ c_N(\tau_N(t)) \exp\left[ \alpha_n (1+O(N^{-1})) (t+1) \right] \notag\\
&\qquad+ 2 \left( \sum_{r=1}^{\tau_N(t)} D_N(r) \right) \exp\left[ \alpha_n (1+O(N^{-1})) (t+1) (1+B_n^\prime) \right] \notag\\
&\qquad+ \left( \sum_{s\in \{r_1,\dots,r_k\} } c_N(s) \right)
\left[ 1 + \alpha_n (1+O(N^{-1})) (1 + B_n^\prime) \right]^k \notag\\
&=: \mathscr{B}_1 + \mathscr{B}_2 + 2\mathscr{B}_3 + \mathscr{B}_4
\end{align}
where we define
\begin{align}
\mathscr{B}_1 &:= \sum_{l=0}^{\tau_N(t)} \frac{1}{l!} \{ - \alpha_n (1+O(N^{-1})) \}^l t^l , \notag\\
...
\mathscr{B}_4 &\leq k \left[ 1 + \alpha_n (1+O(N^{-1})) (1 + B_n^\prime) \right]^k .
\end{align}
