...
%%% BIBLIOGRAPHY
\usepackage[citestyle=authoryear, sorting=nyt, backend=biber]{biblatex}
...
\newmdtheoremenv[backgroundcolor=gray!20, linewidth=0pt]{lemma}{Lemma}
...
\title{Weak convergence proof v.3}
\author{Suzie Brown}
