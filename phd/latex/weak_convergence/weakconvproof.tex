...
\end{align}
using \citet[Equation (3)]{brown2020}. %%% This equation does need modifying for the conditional probability though...
\end{proof}
...
\end{equation}
The expectation of this also vanishes in the limit due to \citet[Equation (4)]{brown2020}.
...
[ Then a LB analogue of Lemma \ref{thm:LOterms_UB} should be enough to conclude.]
