...
A slight modification of the argument allows a similar lower bound to be obtained via (??)\seb{[the LB corresponding to Proposition~\ref{thm:pDelta_LB}]} such that as $N\to\infty$ the bound coincides with the corresponding finite-dimensional distribution of the $n$-coalescent, as required.
