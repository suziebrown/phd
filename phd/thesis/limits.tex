...
A proof is given in \textcite[Proof of Lemma 1 Case 1]{koskela2018}.\seb{refer to the erratum once available, which is more explicit about this proof.}
...
A multinomial expansion of the product on the second line (noting that $(\ON)^a = \ON$ for any power $a\in\mathbb{R}$) yields
\begin{align*}
\chi_d 
