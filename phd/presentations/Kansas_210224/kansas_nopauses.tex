...
\begin{frame}{Sequential Monte Carlo}
%Approximate a sequence of distributions by simulating a population of particles evolving in time
...
%, branching system\footnote{D Crisan, T Lyons. \textit{Probability Theory \& Related Fields}, 1997.}, SSP\footnote{M Gerber, N Whiteley, N Chopin. \textit{Annals of Statistics}, 2019.} resampling
\end{itemize}
\end{frame}
